...
interface UploadedByInfoProps {
  collectionData: CollectionData;
  t: (key: string, vars?: Record<string, string | number | Date>) => string;
}

const UploadedByInfo = ({ collectionData, t }: UploadedByInfoProps) => {
  return (
    <div className="flex items-center justify-start gap-2 fill-gray-700 w-full">
      ...
      <p>
        {t("uploadedBy", {
          ...
          date: new Date(collectionData?.createdAt || "").toLocaleString(),
        })}
      </p>
    </div>
  );
